...
- (void)viewDidLoad {
    ...
    NSArray *articles = [self.supportWidget.dataManager getArticlesByKeyword:self.topic.key orderBy:@[sortDescriptor]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0) {
        ...
        TTLiveAgentWidgetArticleWebViewController *lawa = [[TTLiveAgentWidgetArticleWebViewController alloc] init];
